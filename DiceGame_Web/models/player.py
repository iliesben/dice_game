...
class Player:
    ...
    def __init__(self, name):
        ...
        self.max_non_potential_score = 0
        ...
        while dice_remaining > 0:
            ...
            if response in ['y', 'yes']:
                ...
                if self.score + self.potential_score > params.DEFAULT_TARGET_SCORE:
                    return self.score, self.potential_score, roll, nbr_scoring_dice
            ...
            if nbr_scoring_dice == 0:
                ...
                self.max_non_potential_score = self.potential_score
                print('Non potential score : ', self.non_potential_score)
